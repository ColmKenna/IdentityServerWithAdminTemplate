...
/// <summary>
/// Strongly typed value object representing a token lifetime in seconds, with unit conversions and boundary validation.
/// </summary>
public readonly record struct TokenLifetime : IComparable<TokenLifetime>
{
    ...
    [JsonIgnore]
    public TimeSpan TotalTimeSpan => TimeSpan.FromSeconds(Seconds);
