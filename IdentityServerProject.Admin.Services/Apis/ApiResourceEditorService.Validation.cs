...
public partial class ApiResourceEditorService
{
    ...
    private static bool IsUniqueConstraintViolation(DbUpdateException exception)
    {
        ...
        bool isKnownConstraint = message.Contains("IX_ApiResources_Name", StringComparison.OrdinalIgnoreCase)
                                 || message.Contains("IX_ApiScopes_Name", StringComparison.OrdinalIgnoreCase)
                                 || message.Contains("IX_ApiResourceScopes_ApiResourceId_Scope",
                                 ...
                                 || message.Contains("ApiResourceScopes.ApiResourceId, ApiResourceScopes.Scope",
                                     StringComparison.OrdinalIgnoreCase);
