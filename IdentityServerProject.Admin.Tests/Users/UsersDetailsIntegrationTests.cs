...
public class UsersDetailsIntegrationTests : IDisposable
{
        ...
        UserAccessRevokeResult? accessResult = null)
    {
        ...
        mock.Setup(s => s.GetUserDetailsAsync(It.IsAny<UserActionContext>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((UserActionContext context, CancellationToken __) => context.Target.Value == "non-existent" ? null : (details ?? SampleUser(context.Target.Value)));
    ...
    {
        var mock = new Mock<IUserDetailsService>();
        mock.Setup(s => s.GetUserDetailsAsync(It.Is<UserActionContext>(c => c.Target == UserId.Create("test-user")), It.IsAny<CancellationToken>()))
    ...
    public async Task PostRevokeUserAccess_NonExistentUser_ReturnsNotFound()
    {
        var mock = new Mock<IUserDetailsService>();
        mock.Setup(s => s.GetUserDetailsAsync(It.IsAny<UserActionContext>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((UserActionContext context, CancellationToken __) => context.Target.Value == "non-existent" ? null : SampleUser(context.Target.Value));
        mock.Setup(s => s.RevokeUserAccessAsync(It.Is<UserActionContext>(c => c.Target == UserId.Create("non-existent")), It.IsAny<CancellationToken>()))
    ...
    public async Task PostSuspendUser_ValidTarget_SuspendsAndRedirectsToDangerTab()
    {
        ...
        mock.Setup(s => s.SuspendUserAsync(It.Is<UserActionContext>(c => c.Target == UserId.Create("target-user")), It.IsAny<CancellationToken>()))
    ...
    public async Task PostDeleteUser_ValidConfirmation_DeletesAndRedirectsToIndex()
    {
        ...
        mock.Setup(s => s.GetUserDetailsAsync(It.IsAny<UserActionContext>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((UserActionContext context, CancellationToken __) => SampleUser(context.Target.Value));
        mock.Setup(s => s.DeleteUserAsync(It.Is<UserActionContext>(c => c.Target == UserId.Create("target-user")), It.IsAny<CancellationToken>()))
        ...
        mock.Verify(s => s.DeleteUserAsync(It.Is<UserActionContext>(c => c.Target == UserId.Create("target-user")), It.IsAny<CancellationToken>()), Times.Once);
    }
