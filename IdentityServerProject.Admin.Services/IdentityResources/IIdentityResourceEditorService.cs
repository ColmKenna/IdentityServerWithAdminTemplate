...
{
    Task<AdminMutationResult> CreateAsync(CreateIdentityResourceCommand command, CancellationToken cancellationToken = default);
    ...
    /// a user claim).
    /// </summary>
    Task<IdentityResourceEditResult> AddClaimAsync(ScopeName name, ClaimType claimType, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<IdentityResourceEditResult> RemoveClaimAsync(ScopeName name, ClaimType claimType, CancellationToken cancellationToken = default);
}
