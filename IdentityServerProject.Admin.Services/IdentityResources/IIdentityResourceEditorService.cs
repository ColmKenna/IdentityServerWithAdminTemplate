...
public class IdentityResourceCreateResult
{
    ...
    public static IdentityResourceCreateResult Failed(string errorMessage) => new() { Success = false, ErrorMessage = errorMessage };
    public static IdentityResourceCreateResult Succeeded() => new() { Success = true };
}
...
public interface IIdentityResourceEditorService
{
    ...
    /// </summary>
    Task<IdentityResourceCreateResult> CreateAsync(
        string name,
        string? displayName,
        string? description,
        bool enabled,
    ...
    /// </summary>
    Task<IdentityResourceEditorModel?> GetForEditAsync(string name, CancellationToken cancellationToken = default);
    ...
    /// a user claim).
    /// </summary>
    Task<IdentityResourceEditResult> AddClaimAsync(string name, string claimType, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<IdentityResourceEditResult> RemoveClaimAsync(string name, string claimType, CancellationToken cancellationToken = default);
}
